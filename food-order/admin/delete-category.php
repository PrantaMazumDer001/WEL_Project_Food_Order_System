                                                                ...
                                                                */
                                                                    ...
                                                                    if($image_name != ""){
                                                                                            ...
                                                                                            $remove = unlink($path);
                                                                                                    if($remove == false){
                                                                                                                            ...
                                                                                                                            $_SESSION['delete-image-u'] = "<div class = 'error' > Fail to delete the category. </div>";
                                                                ...
                                                                $res = mysqli_query($conn , $sql ) or die(mysqli_error());
                                                                    ...
                                                                    if($res==true)
                                                                    {
                                                                        ...
                                                                        $_SESSION['category-delete-s'] = "<div class = 'success' >Successfully delete the category. </div>";
                                                                ...
                                                                // if data is not inserted then this message is shown
                                                                $_SESSION['delete-image-e'] = "<div class = 'error' > Invalid arrgument passing. </div>";
